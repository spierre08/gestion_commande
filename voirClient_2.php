...
<head>
    ...
    <title>GCommande/Informations sur le client</title>
            ...
            <div class="main_table">
                <form action="" method="POST">
			 	<input type="hidden" name="id" id="" value="<?php echo $valeur["id_client"]; ?>">
                    <label>Nom</label>
                    <input type="text" name="nom" id="" value="<?php echo $valeur["nom_client"]; ?>" disabled>
                    <label>Prénom</label>
                    <input type="text" name="prenom" id="" value="<?php echo $valeur["prenom_client"]; ?>" disabled>
                    <label>Téléphone</label>
                    <input type="tel" name="tel" id="" value="<?php echo $valeur["tel_client"]; ?>"min="0" maxlength="9" disabled>
                    <label>Email</label>
                    <input type="email" name="email" id="" value="<?php echo $valeur["email_client"]; ?>" disabled>
                    <label>Adresse</label>
                    <input type="text" name="adresse" id="" value="<?php echo $valeur["adresse_client"]; ?>" disabled>
                </form>
            </div>
            <div class="footer">
