...
<head>
    ...
    <title>GCommande/Détail commande</title>
        ...
        <div class="main">
            <div class="main_option">
                ...
                <div class="main_sub_option">
                    <a href="addDetail.php">Ajouter</a>
                </div>
            </div>
            <hr>
            <div class="main_table">
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <a href="voirDetail.php?id=<?php echo $affichages['id_ligne']; ?>"><img src="icone/view.png" alt="" width="30px"></a>
                            </td>
                        </tr>
                    </tbody>
                    <?php
                ...
                <div class="main_pagination">
                    ...
                    <?php
                        if ($page>1){
                    ?>
                    <a href="detail.php?page=<?php echo ($page-1); ?>">Précedant</a>
                    <?php 
                        }
                    ?>
                    <?php
                        ...
                        for($i=1; $i<=$total; $i++){
                    ?>
                    <a href="detail.php?page=<?php echo ($i); ?>"><?php echo $i; ?></a>
                    <?php
                        }
                        ...
                        if($i>$page){
                    ?>
                    <a href="detail.php?page=<?php echo ($page+1); ?>">Suivant</a>
                    <?php
                        }
                    ?>
                </div>
