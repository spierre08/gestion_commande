        ...
        <?php
            ...
            <tbody>
                <tr>
                        ...
                        <td><a href="editArticle.php?id=<?php echo $row->id_article; ?>"><img src="icone/edit.png" alt="" srcset="" width="30px"></a> <a href="supArticle.php?id=<?php echo $row->id_article; ?>"><img src="icone/delete.png" alt="" srcset="" width="30px"></a></td>
                    </td>
                </tr>
            </tbody>
        </table>
