...
<head>
    ...
    <title>GCommande/Commande</title>
    ...
    <div class="wrap">
        ...
        <div class="header">
            <div class="sub_option">
                ...
                <span style="font-weight: 600;"><?php echo $_SESSION["email"]; 
                ?></span>
            </div>
        ...
        <div class="main">
            <div class="main_option">
                ...
                <div class="main_sub_option">
                    <a href="rchCommande.php">Rechercher</a>
                    <a href="addCommande.php">Ajouter</a>
                </div>
            </div>
            <hr>
            <div class="main_table">
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <a href="editerCommande.php?id=<?php echo $affichages["id_commande"]; ?>"><img src="icone/edit.png" alt="" width="30px"></a>
                            </td>
                        </tr>
                    </tbody>
                    <?php
                ...
                <div class="main_pagination">
                    ...
                    <?php
                        if ($page>1){
                    ?>
                    <a href="commande.php?page=<?php echo ($page-1); ?>">Précedant</a>
                    <?php
                        }
                    ?>
                     <?php
                        ...
                        for($i=1; $i<=$total; $i++){
                    ?>
                    <a href="commande.php?page=<?php echo ($i); ?>"><?php echo $i; ?></a>
                    <?php
                        }
                        ...
                        if($i>$page){
                    ?>
                    <a href="commande.php?page=<?php echo ($page+1); ?>">Suivant</a>
                    <?php
                        }
                    ?>
                </div>
