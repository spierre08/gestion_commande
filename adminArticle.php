...
<head>
    ...
    <title>GCommande/Article admin</title>
        ...
        <div class="main">
            <div class="main_option">
                ...
                <div class="main_sub_option">
                    <a href="rechercherArticle.php">Rechercher</a>
            ...
            <div class="main_table">
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <a href="editArticle.php?id=<?php echo $affichages["id_article"]; ?>"><img src="icone/edit.png" alt="" width="30px"></a>
                                <a href="supArticle.php?id=<?php echo $affichages["id_article"]; ?>"><img src="icone/delete.png" alt="" width="30px"></a>
                            </td>
                            </tr>
                        </tbody>
                        <?php
                ...
                <?php
                    ...
                    ?>
                    <a href="adminArticle.php?page=<?php echo ($page-1); ?>">Précedant</a>
                    <?php
                        }
                    ?>
                    <?php
                        ...
                        for($i=1; $i<=$total; $i++){
                    ?>
                    <a href="adminArticle.php?page=<?php echo ($i); ?>"><?php echo $i; ?></a>
                    <?php
                        }
                        if($i>$page){
                    ?>
                    <a href="adminArticle.php?page=<?php echo ($page+1); ?>">Suivant</a>
                    <?php
                        }
                    ?>
                </div>
