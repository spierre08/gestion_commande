    ...
    <div class="container">
        ...
        <?php
                ...
                if (isset($_POST['rechercher'])){
                    ...
                    $requette = $pdo->prepare("SELECT * from t_client WHERE nom_client=? or adresse_client=? or id_client=? or tel_client=?");
            ...
            <tbody>
                <tr>
                        ...
                        <td><a href="voirClient_2.php?id=<?php echo $row->id_client; ?>"><img src="icone/edit.png" alt="" srcset="" width="30px"></a> <a href="supClient.php?id=<?php echo $row->id_client; ?>"><img src="icone/delete.png" alt="" srcset="" width="30px"></a></td>
                    </td>
                </tr>
            </tbody>
        </table>
