...
<head>
    ...
    <title>GCommande/Utilisateur</title>
        ...
        <div class="main">
            <div class="main_option">
                ...
                <div class="main_sub_option">
                    <a href="addUtilisateur.php">Ajouter</a>
                </div>
            </div>
            <hr>
            <div class="main_table">
                <table>
                    ...
                    <?php
                        ...
                        $affichage = $pdo->query("SELECT * FROM t_utilisateur LIMIT $debut,$nbr_page");
                        #Boucle de parcour des données
                        while($affichages = $affichage->fetch()):
                    ?>
                    <tbody>
                        <tr>
                            <td><?= $affichages["role_user"] ?></td>
                            <td><?= $affichages["pseudo"] ?></td>
                            <td><?= $affichages["mot_de_passe"] ?></td>
                            <td>
                                <a href="voir_user.php?id=<?= $affichages['id_utilisateur'] ?>">
                                    <img src="icone/edit.png" alt="" width="30px">
                                </a>
                                <a href="supUser.php?id=<?= $affichages["id_utilisateur"] ?>"><img src="icone/delete.png" alt="" width="30px"></a>
                            </td>
                        </tr>
                    </tbody>
                    <?php endwhile ?>
                ...
                <?php
                        ...
                        $query = $pdo->query("SELECT * FROM t_utilisateur");
                    ...
                    ?>
                     <?php
                        if ($page>1){
                    ?>
                    <a href="utilisateur.php?page=<?php echo ($page-1); ?>">Précedant</a>
                    <?php
                        }
                    ...
                    <a href="utilisateur.php?page=<?php echo ($i); ?>"><?php echo $i; ?></a>
                    <?php
                        }
                        ...
                        if($i>$page){
                    ?>
                    <a href="utilisateur.php?page=<?php echo ($page+1); ?>">Suivant</a>
                    <?php
                        }
                    ?>
                </div>
                ...
                <?php
                    ...
                    $enreg = $pdo->query("SELECT count(*) as nb from t_utilisateur");
